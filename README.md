...
| `network_recovery_interval` | Long | (required, positive) | Network recovery interval; sample uses `30`. Customers may set lower positive values such as `5`. Omitted/zero/negative values fail startup validation. |
