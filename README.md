...
rabbitmq.inplay.network_recovery_interval=500
...
| `network_recovery_interval` | Long | (required, positive) | Network recovery interval (ms); sample uses `500` (was `3000`). Omitted/zero/negative values fail startup validation. |
