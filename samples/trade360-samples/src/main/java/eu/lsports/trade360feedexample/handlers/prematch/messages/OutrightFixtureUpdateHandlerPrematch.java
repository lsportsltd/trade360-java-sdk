...
import eu.lsports.trade360_java_sdk.common.entities.message_types.OutrightFixtureUpdate;
...
public class OutrightFixtureUpdateHandlerPrematch implements EntityHandler<OutrightFixtureUpdate> {
    ...
    @Override
    public void process(OutrightFixtureUpdate entity, Map<String, String> messageHeaders, Map<String, String> transportMessageHeaders) {
